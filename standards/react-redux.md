...
1. [Directory structure](https://github.com/decentraland/dcl-standards/blob/master/react/README.md#directory-structure)
2. [Naming conventions and file structure](https://github.com/decentraland/dcl-standards/blob/master/react/README.md#naming-conventions-and-file-structure)
3. [Performance](https://github.com/decentraland/dcl-standards/blob/master/react/README.md#performance)
4. [TypeScript](https://github.com/decentraland/dcl-standards/blob/master/react/README.md#typescript)
5. [Bonus tracks](https://github.com/decentraland/dcl-standards/blob/master/react/README.md#bonus-tracks)
